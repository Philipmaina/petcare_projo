...
ActiveRecord::Schema.define(version: 20160421065158) do
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.datetime "created_at",                                        null: false
    t.datetime "updated_at",                                        null: false
    t.integer  "rating_after_complete_pet_stay"
  end
  ...
  create_table "notificationforpetowners", force: :cascade do |t|
    t.integer  "petowner_id"
  ...
  add_index "notificationforpetowners", ["booking_id"], name: "index_notificationforpetowners_on_booking_id"
  add_index "notificationforpetowners", ["petowner_id"], name: "index_notificationforpetowners_on_petowner_id"
